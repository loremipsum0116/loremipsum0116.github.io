var store = [{
        ...
        "excerpt":"MVC 패턴의 이해와 JSP, Spring MVC에서의 활용: 효율적인 웹 애플리케이션 아키텍처 본 문서에서는 웹 애플리케이션 개발에서 가장 널리 사용되는 디자인 패턴 중 하나인 MVC(Model-View-Controller) 패턴에 대해 심층적으로 다룹니다. MVC가 무엇인지, 왜 필요한지, 그리고 JSP 기반 웹 애플리케이션에서 어떻게 MVC 구조를 구현하고 데이터를 효율적으로 관리하는지에 대해 실전 예시와 함께 설명합니다. 또한,...","categories": ["jsp"],
        "tags": [],
        "url": "/ko/jsp.basic(8)/",
        "teaser": null
      },{
        "title": "JSP/서블릿 MVC를 활용한 CRUD 애플리케이션 구현",
        "excerpt":"JSP/서블릿 MVC를 활용한 CRUD 애플리케이션 구현: 회원 관리 시스템 본 문서에서는 JSP와 서블릿을 기반으로 하는 MVC 패턴을 적용하여 간단한 회원 관리 CRUD(Create, Read, Update, Delete) 애플리케이션을 직접 구현해봅니다. 이 과정을 통해 request.setAttribute(), RequestDispatcher.forward(), EL(Expression Language), JSTL(JSP Standard Tag Library), JavaBean, DAO(Data Access Object) 등의 핵심 기술들이 실제 프로젝트 환경에서 어떻게...","categories": ["jsp"],
        "tags": [],
        "url": "/ko/jsp.basic(9)/",
        "teaser": null
      },{
