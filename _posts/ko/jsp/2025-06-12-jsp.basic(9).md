...
public class MemberDAO {
    ...
    static {
        members.put("admin", new Member("admin", "1234", "반", "admin@example.com"));
        members.put("user1", new Member("user1", "pass1", "리카르도", "kim@example.com"));
        members.put("user2", new Member("user2", "pass2", "빌리", "lee@example.com"));
    }
